...
from .views import HomeView, PortfolioView, LabsView, TutorialView, SiteExperimentalView, DetailCategoryView, DetailPortfolioView, DetailTutorialView, DetailLabsView, CommentsView, GameView
...
urlpatterns = patterns('',
    ...
    url(r'^games/survivingninja$', GameView.as_view(), name='surviving ninja'),
